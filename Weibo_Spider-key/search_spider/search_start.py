...
def fetch_weibo_data(keyword, start_time, end_time, page_id):
    ...
    mycookie = "SINAGLOBAL=3496136235056.4463.1541040811587; UM_distinctid=1696c6c69c80-02af6028746f6-172a1c0b-1fa400-" \
               "1696c6c69ca1f6; _s_tentry=-; Apache=2020556029463.3894.1556414537512; ULV=1556414537535:21:6:1:" \
               "2020556029463.3894.1556414537512:1556031182464; WBtopGlobal_register_version=84a7c082648185f6; " \
               "ALF=1587951851; SSOLoginState=1556415854; SUB=_2A25xwXUhDeThGeNL7FcX9izMzT-IHXVSt-" \
               "HprDV8PUNbmtBeLRnekW9NSPOSAiX4TOBDgBrmdUdE9aIG-g1xfnfb; SUBP=0033WrSXqPxfM725Ws9jqgMF5" \
               "5529P9D9WFIE6KsnV1qpcU_7ES.krnN5JpX5KzhUgL.Fo-fS0-cSoz7Soe2dJLoIpvKdgLjIg4ri--ci-" \
               "z7i-zRi--ciKnpiK.EeK.4e02p; SUHB=0TPFicm5Z8-YRN; wvr=6; UOR=news.ifeng.com,widget." \
               "weibo.com,www.google.com; webim_unReadCount=%7B%22time%22%3A1556422157384%2C%22dm_" \
               "pub_total%22%3A2%2C%22chat_group_pc%22%3A0%2C%22allcountNum%22%3A3%2C%22msgbox%22%3A0%7D"

    headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
                             'Chrome/65.0.3325.181 Safari/537.36', "cookie": mycookie}

    resp = requests.get(url_template.format(keyword, start_time, end_time, page_id), headers=headers, allow_redirects=False)

    print(resp.url)
    print("相应状态码", resp.status_code)
    print("网页请求头部", resp.request.headers)  # 网页请求头部
    print("网页请求报错", resp.raise_for_status())  # 网页请求报错
...
def fetch_pages(keyword, start_time, end_time):
    """
    使用beatifulsoul获取网页sorce代码，来获取页码信息，获取页码信息后，使用fetch_weibo_data来爬取当前页面信息
    ...
    mycookie = "SINAGLOBAL=3496136235056.4463.1541040811587; UM_distinctid=1696c6c69c80-02af6028746f6-172a1c0b-1fa400-" \
               ...
               "2020556029463.3894.1556414537512:1556031182464; WBtopGlobal_register_version=84a7c082648185f6; " \
               "ALF=1587951851; SSOLoginState=1556415854; SUB=_2A25xwXUhDeThGeNL7FcX9izMzT-IHXVSt-" \
               "HprDV8PUNbmtBeLRnekW9NSPOSAiX4TOBDgBrmdUdE9aIG-g1xfnfb; " \
               "SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFIE6KsnV1qpcU_7ES.krnN5JpX5KzhUgL." \
               "Fo-fS0-cSoz7Soe2dJLoIpvKdgLjIg4ri--ci-z7i-zRi--ciKnpiK.EeK.4e02p; " \
               "SUHB=0TPFicm5Z8-YRN; wvr=6; UOR=news.ifeng.com,widget.weibo.com,www.google.com; " \
               "webim_unReadCount=%7B%22time%22%3A1556422157384%2C%22dm_" \
               "pub_total%22%3A2%2C%22chat_group_pc%22%3A0%2C%22allcountNum%22%3A3%2C%22msgbox%22%3A0%7D"
    headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
                             'Chrome/65.0.3325.181 Safari/537.36', "cookie": mycookie}
    ...
    file_name = "../data_store/{}_{}.json".format(keyword, start_time)
...
if __name__ == '__main__':
    ...
    #
    # keyword = "武汉大雨"
    # start_time = "2019.4.28.9"
    # end_time = "2019.4.28.10"
    ...
    file_name0 = "./{}_{}_{}".format(keyword, start_time, end_time)
